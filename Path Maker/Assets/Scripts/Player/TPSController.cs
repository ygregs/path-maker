...
namespace StarterAssets
{
    ...
    public class TPSController : NetworkBehaviour
    {
        ...
        private NetworkVariable<AnimationState> networkAnimationState = new NetworkVariable<AnimationState>();
        private AnimationState oldPlayerState = AnimationState.Idle;
        ...
        [ServerRpc]
        public void UpdatePlayerStateServerRpc(AnimationState state)
        {
        ...
        private void Start()
        {
            ...
            _hasAnimator = TryGetComponent(out _netAnimator);
        ...
        private void GroundedCheck()
        {
            ...
            if (_hasAnimator)
            {
                ...
                _netAnimator.Animator.SetBool(_animIDGrounded, Grounded);
                // if (Grounded)
                //     UpdatePlayerStateServerRpc(AnimationState.Grounded);
                // else
                // {
                //     UpdatePlayerStateServerRpc(AnimationState.Jump);
                // }
        ...
        private void Move()
        {
            ...
            if (_hasAnimator)
            {
                ...
                if (currentHorizontalSpeed == 0)
                {
                    ...
                    UpdatePlayerStateServerRpc(AnimationState.Idle);
                }
                else
                {
                    UpdatePlayerStateServerRpc(AnimationState.Walk);
        ...
        private void JumpAndGravity()
        {
            if (Grounded)
            {
                ...
                if (_hasAnimator)
                {
                    ...
                    _netAnimator.Animator.SetBool(_animIDJump, false);
                    _netAnimator.Animator.SetBool(_animIDFreeFall, false);
                }
                ...
                if (_input.jump && _jumpTimeoutDelta <= 0.0f)
                {
                    ...
                    if (_hasAnimator)
                    {
                        ...
                        _netAnimator.Animator.SetBool(_animIDJump, true);
                        // UpdatePlayerStateServerRpc(AnimationState.Jump);
                    }
                }
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (_hasAnimator)
                    {
                        ...
                        _netAnimator.Animator.SetBool(_animIDFreeFall, true);
                        // UpdatePlayerStateServerRpc(AnimationState.FreeFall);
                    }
                }
