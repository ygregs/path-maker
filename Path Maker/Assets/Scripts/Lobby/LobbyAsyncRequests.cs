...
namespace PathMaker
{
    ...
    public class LobbyAsyncRequests
    {
        ...
        /// </summary>
        public void QuickJoinLobbyAsync(LobbyUser localUser, Action<Lobby> onSuccess = null, Action onFailure = null)
        {
        ...
        public void RetrieveLobbyListAsync(Action<QueryResponse> onListRetrieved, Action<QueryResponse> onError = null)
        {
            if (!m_rateLimitQuery.CanCall())
            {
                onListRetrieved?.Invoke(null);
                m_rateLimitQuery.EnqueuePendingOperation(() => { RetrieveLobbyListAsync(onListRetrieved, onError); });
